        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="col-md-3">
              ...
              <img src="{{ url('/profile_picture/' . $salary['avatar']) }}" class="img-responsive img-thumbnail" width="250px">
              @else
              <img src="{{ url('/profile_picture/ht.png') }}" alt="blank_profile_picture" class="img-responsive img-thumbnail" width="160px">
              @endif
            </div>
            <!-- /. end col -->
          </div>
