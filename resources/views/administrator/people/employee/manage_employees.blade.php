                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                               ...
                               /
                               <a href="{{ url('/people/employees/delete/' . $employee['id']) }}"><i class="icon fa fa-delete"></i> {{ __('delete') }}</a>
                              /
                              <a href="{{ url('/people/employees/active/' . $employee['id']) }}"><i class="icon fa fa-delete"></i> {{ __('Active') }}</a>
                              /
                              <a href="{{ url('/people/employees/deactive/' . $employee['id']) }}"><i class="icon fa fa-delete"></i> {{ __('Deactive') }}</a>
                              /
                              <a href="{{ url('/people/employees/details/' . $employee['id']) }}"><i class="icon fa fa-delete"></i> {{ __('Details') }}</a>
                              
                            </td>
                               <!-- <a href="{{ url('/people/employees/destroy/' . $employee['id']) }}"><i class="icon fa fa-delete"></i> {{ __('delete') }}</a> -->
                               <!-- <form  method="post" action="{{action('EmplController@destroy',$employee['id'])}}">
                                {{csrf_field()}}
