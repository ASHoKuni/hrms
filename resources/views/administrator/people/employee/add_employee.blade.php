                    ...
                    <div class="row">
                      ...
                      $users = \App\User::orderBy('id', 'desc')->first();
                        ...
                        <div class="col-md-6">
                            ...
                            <label for="contact_no_one">{{ __('Primary Phone') }}<span class="text-danger">*</span></label>
                            ...
                            <label for="emergency_contact">{{ __('Secondary Phone') }}</label>
                            <div class="form-group{{ $errors->has('emergency_contact') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="emergency_contact" id="emergency_contact" class="form-control" value="{{ old('emergency_contact') }}" placeholder="{{ __('Enter Secondary Phone no..') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('id_name') ? ' has-error' : '' }} has-feedback">
                                <select name="id_name" id="id_name" class="form-control">
                                    <option value="" selected disabled>{{ __('Select one') }}</option>
                                    <option value="1">{{ __('Aadhaar') }}</option>
