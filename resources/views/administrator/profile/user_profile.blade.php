                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            @else
                            <p class="text-yellow">{{ __('You can update your profile. All') }} (<span class="text-danger">*</span>) {{ __('field are required.') }} </p>
                            @endif
                        </div>
                        <!-- /.Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="name" id="name" class="form-control" value="{{ $user['name'] }}" placeholder="{{ __('Enter name..') }}">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group{{ $errors->has('contact_no_one') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="contact_no_one" id="contact_no_one" class="form-control" value="{{ $user['contact_no_one'] }}" placeholder="{{ __('Enter contact no..') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('present_address') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="present_address" id="present_address" class="form-control" value="{{ $user['present_address'] }}" placeholder="{{ __('Enter contact no..') }}">
                            ...
                            <label for="permanent_address">{{ __('Permanent Address') }} <span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('permanent_address') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="permanent_address" id="permanent_address" class="form-control" value="{{ $user['permanent_address'] }}" placeholder="{{ __('Enter contact no..') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <img src="{{ url('/profile_picture/' . $user['avatar']) }}" alt="$user['avatar']" class="img-responsive img-thumbnail">
                            @else
