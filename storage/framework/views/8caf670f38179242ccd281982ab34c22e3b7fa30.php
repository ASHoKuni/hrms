...
<html>
    <head>
        ...
        <!-- Bootstrap 3.3.7 -->
        <link rel="stylesheet" type="text/css" href="<?php echo URL::asset('/backend/bower_components/bootstrap/dist/css/bootstrap.min.css'); ?>">
        <!-- Font Awesome -->
        <link rel="stylesheet" type="text/css" href="<?php echo URL::asset('/backend/bower_components/font-awesome/css/font-awesome.min.css'); ?>">
        <!-- Ionicons -->
        <link rel="stylesheet" type="text/css"  href="<?php echo URL::asset('/backend/bower_components/Ionicons/css/ionicons.min.css'); ?>">
        <!-- Theme style -->
        <link rel="stylesheet" type="text/css" href="<?php echo URL::asset('/backend/dist/css/AdminLTE.min.css'); ?>">
        <!-- iCheck -->
        <link rel="stylesheet" type="text/css" href="<?php echo URL::asset('/backend/plugins/iCheck/square/blue.css'); ?>">
        <!-- Google Font -->
    ...
    <body class="hold-transition login-page">
        ...
        <div class="login-box">
            <div class="login-logo">
                <a><b><?php echo __('Payroll System'); ?></b></a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                <p class="login-box-msg"><?php echo __('Sign in'); ?></p>
