                    ...
                    <div class="row">
                      ...
                      $users = \App\User::orderBy('id', 'desc')->first();
                        ...
                        <div class="col-md-6">
                            ...
                            <label for="contact_no_one"><?php echo __('Primary Phone'); ?><span class="text-danger">*</span></label>
                            ...
                            <label for="emergency_contact"><?php echo __('Secondary Phone'); ?></label>
                            <div class="form-group<?php echo $errors->has('emergency_contact') ? ' has-error' : ''; ?> has-feedback">
                                <input type="text" name="emergency_contact" id="emergency_contact" class="form-control" value="<?php echo old('emergency_contact'); ?>" placeholder="<?php echo __('Enter Secondary Phone no..'); ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo $errors->has('id_name') ? ' has-error' : ''; ?> has-feedback">
                                <select name="id_name" id="id_name" class="form-control">
                                    <option value="" selected disabled><?php echo __('Select one'); ?></option>
                                    <option value="1"><?php echo __('Aadhaar'); ?></option>
