<?php $__env->startSection('title', __('Edit employee details')); ?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo url('/people/employees'); ?>">   <?php echo __('Edit Employee'); ?></a></li>
            <li class="active">   <?php echo __('Edit employee details'); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">   <?php echo __('Edit employee details'); ?></h3>
